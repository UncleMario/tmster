# Django settings for tmster project.
import os, sys
...
SECRET_KEY = 't9do-_t23^7$d9+nm@n+#ekrg*)7_dls3^4#64%w)bs08agv*!'
...
WSGI_APPLICATION = 'tmster.wsgi.application'
...
FACEBOOK_LOGIN_DEFAULT_REDIRECT = '/home/'
